            ...
            <fieldset>
                ...
                <p>
                    ...
                    <select name="disposition" class="custom-select select">
                        ...
                        <option value="I" class="custom-option">I</option>
                        <option value="O" class="custom-option">O</option>
                        <option value="S" class="custom-option">S</option>
                        <option value="N" class="custom-option">N</option>
                    </select>
                </p>
            </fieldset>
        </div>
